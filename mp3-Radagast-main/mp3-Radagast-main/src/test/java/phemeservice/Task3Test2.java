...
public class Task3Test2 {
    ...
    public void testAddSecondUser() {
        ...
        assertTrue(srv.addUser(userID3, userName3, hashPwd3));
    }
    ...
    public void testReceiveMsg() {
        ...
        assertEquals(msg1, srv.getNext(userName3, hashPwd3));
    }
    ...
    public void testMsgDelivered() {
        ...
        userList.add(userID2);
        userList.add(userID3);
        assertTrue(srv.isDelivered(msg1.getId(), userList).get(1));
    }
    ...
    public void testAddSubscription1() {
        assertTrue(srv.addSubscription(userName2, hashPwd2, "SongliDu"));
    }
    @Test
    @Order(12)
    public void getRecentMsgs1() {
        int numOfMsg = srv.getAllRecent(userName2, hashPwd2).size();
